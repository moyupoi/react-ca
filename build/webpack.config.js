...
const {__DEV__, __PROD__, __TEST__, __STAG__} = config.globals
...
webpackConfig.module.loaders = [{
  ...
  query: {
    cacheDirectory: true,
    plugins: ['lodash', 'transform-runtime', ['antd']],
...
},
{
 ...
 {
   test: /\.js$/,
   include: paths.base('node_modules/webworkify/index.js'),
   loader: 'worker'
}]
